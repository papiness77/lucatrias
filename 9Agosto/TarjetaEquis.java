...
public class TarjetaEquis {
    ...
    public String toString(){
        ...
        for(Viaje a : this.viajeArrayList){
            elementosConcatenados="hora: " + a.getHora() + " | fecha: " + a.getFecha() + " | precio: " + a.getPrecio() + " | saldo: " + saldo;
            elmentos2 +=  saltodelinea+ elementosConcatenados;
        }
        return elmentos2;
    }
}